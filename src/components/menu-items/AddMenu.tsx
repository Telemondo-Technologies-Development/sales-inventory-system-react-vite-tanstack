  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center">
      ...
      <form
        ...
        className="relative z-10 w-full max-w-lg bg-primary-foreground rounded-2xl p-6 elevation-1"
      >
        <h3 className="text-lg font-semibold mb-4 text-primary">Add Menu Item</h3>

        <div className="space-y-3">
          <div>
            <label className="block text-sm font-medium mb-1 text-foreground">Name</label>
            <input value={name} onChange={(e) => setName(e.target.value)} className="w-full px-3 py-2 border border-border rounded-2xl" />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 rounded-2xl border border-border"
            />
          </div>

          <div>
            <label className="block text-sm font-medium mb-1">Category</label>
            <select value={category} onChange={(e) => setCategory(e.target.value)} className="w-full px-3 py-2 border rounded-2xl border-border">
              <option>Main</option>
              <option>Sides</option>
          ...
          <div>
            ...
            <input type="file" accept="image/*" className=" border rounded-2xl border-border bg-primary-container text-on-primary-container p-1" onChange={handleFileChange} />
